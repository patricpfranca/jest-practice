...
it("map(1) should return throw a TypeError with message 'The first parameter must be an array'", () => {
  let error;
...
it("map([1, 2], 'function') should return throw a TypeError", () => {
  let error;
...
it("map([1, 2], 'function') should return throw a TypeError with message 'The second parameter must be a function'", () => {
  let error;
